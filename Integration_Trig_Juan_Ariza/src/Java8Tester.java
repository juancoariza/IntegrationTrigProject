...
public class Java8Tester {
  ...
  /** Example of Lambda declarations.
   * @param args handles main operation
   */
  public static void main(String args[]) {
    ...
    /*
     * the -> operation omits having the datatype declaration for the following
     * operation type " a + b " is equivalent to "int answer = a + b
     */
  ...
  interface MathOperation {
    ...
    /*
     * Having the MathOperation as an interface allows the program to implement
  ...
  interface GreetingService {
    ...
    /*
     * replacing every method with an interface creates the most "generic" way
     * possible - cutting out all assignments to datatypes. This is the most
     * optimized style of code possible in Java
     */
  }
