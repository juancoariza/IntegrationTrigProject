 ...
 * fields listen within. in this case, every class that implements this
 * Interface must have an array to accept side values, an array to accept angle
 * values, and the defined constant MAXANGLEVALUE
 */